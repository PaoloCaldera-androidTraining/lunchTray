...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        val action =
            AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToCheckoutFragment()
    ...
    fun cancelOrder() {
        ...
        val action =
            AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragmentToStartOrderFragment()
        findNavController().navigate(action)
    }
